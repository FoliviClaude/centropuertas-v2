...
def render() -> None:
    ...
    # Tableau de bord personnel : uniquement les totaux du technicien
    # connecté, jamais ceux de toute l'équipe.
    ...
    totales = db.get_totales_anuales(anio, technician_name)
    ...
    datos_mes = db.get_totales_por_mes(anio, technician_name)
