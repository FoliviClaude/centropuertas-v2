...
from utils.pwa import boton_instalar_app
...
def render() -> None:
    ...
    st.markdown(f"**{t('ajustes.instalar_app')}**")
    st.caption(t("ajustes.instalar_app_desc"))
    boton_instalar_app(
        etiqueta=t("ajustes.instalar_app_boton"),
        etiqueta_instalada=t("ajustes.instalar_app_hecho"),
        ayuda_ios=t("ajustes.instalar_app_ios"),
    )
